...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> dict:
        ...
        """
        informationdict = {}
        informationdict["page_size"] = page_size
        informationdict["page"] = page
        informationdict["data"] = self.get_page(page, page_size)
        totalpages = math.ceil((len(self.__dataset) / page_size))
        informationdict["prev_page"] = page - 1 if page > 1 else None
        informationdict["next_page"] = page + 1 if page < totalpages else None
        informationdict["total_pages"] = totalpages
